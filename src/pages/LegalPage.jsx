...
const pages = {
  terms: {
    ...
    content: [
      ...
      { h: '4. Subscription & Billing', p: 'The Service offers a Free Plan with limited features and a Premium Plan at ₹9,999 per year. Payment is due upfront. All fees are non-refundable except as required by law. We may change pricing with 30 days notice. Non-payment may result in account suspension.' },
